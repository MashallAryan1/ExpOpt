...
class MlpRegressor(object):
    ...
    def __init__(self,**kwargs):
        ...
        Args:
            ...
            'use_batch_normalization':       Boolean (default=True)
            'weight_decay' : real (default=None)
        """
    ...
    def build_model(self):
        ...
        for layer in range(2,self.n_layers):
            ...
            # next dense layer
            initseed+=1000
            self.model.add(Dense(self.structure[layer],kernel_initializer=kernel_initializer(seed=initseed), kernel_regularizer=kernel_regularizers[layer-1]))
